...
export const RdishComment = (state = { dishComments: null, errMess: null, errMessTwo: null }, action) => {
    switch (action.type) {
        ...
        case ActionTypes.DISH_COMMENTS_FAILED:
            return { ...state, dishComments: null, errMess: action.payload, errMessTwo: null }
        ...
        case ActionTypes.NEW_DISH_COMMENT_FAILED:
            return { ...state, dishComments: null, errMess: null, errMessTwo: action.payload }
        default:
            return state
    }
}